...
namespace Services.Models
{
    ...
    public partial class ServiceResource
    {
        ...
        public ServiceResource(IDictionary<string, object> additionalProperties = default(IDictionary<string, object>), System.DateTime? creationTime = default(System.DateTime?), string instanceSize = default(string), int? instanceCount = default(int?), string status = default(string))
        {
        ...
        /// <summary>
        /// Gets or sets possible values include: 'Creating', 'Running',
